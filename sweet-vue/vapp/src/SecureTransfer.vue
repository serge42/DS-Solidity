<template>
  <div v-if="isDrizzleInitialized">
    <div>
      <drizzle-contract contractName="SecureTransfer" method="price" label="Starting price" />
      <drizzle-contract contractName="SecureTransfer" method="seller" label="Seller" />
      <div class="flex-container">
        <drizzle-contract contractName="SecureTransfer" method="offer" label="Highest offer" />
        <drizzle-contract contractName="SecureTransfer" method="buyer" label="by" />
      </div>
      <div v-if="isSeller">
        <div v-if="!hasOffer">
        ...
        <div v-if="isActive">
          <div class="flex-container">
            ...
            <drizzle-contract-form contractName="SecureTransfer" method="acceptOffer" />
          </div>
        </div>
...
export default {
  ...
  computed: {
    ...
    isSeller() {
      ...
      const bar = this.getContractData({
        contract: "TestContract",
        method: "foo"
      });
      console.log("Internal state: " + bar);
    ...
    hasOffer() {
      const offer = this.getContractData({
        contract: "SecureTransfer",
        method: "offer"
      });
